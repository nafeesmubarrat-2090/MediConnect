...
public class AmbulanceServicePage {
    ...
    private String currentLocation = "23.8103° N, 90.4125° E"; // Default Dhaka location
    private CheckBox insuranceCheckBox;
    private String selectedCity = "All Cities"; // Default to show all
    ...
    public BorderPane getView() {
        ...
        Label title = new Label(getText("Ambulance & Emergency Services", "অ্যাম্বুলেন্স ও জরুরি সেবা"));
        title.setStyle("-fx-font-size: 18px; -fx-font-weight: bold;");

        // Panic Button - Always visible
        Button panicBtn = new Button("🚨 SOS");
        panicBtn.setStyle("-fx-background-color: #ff0000; -fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 14px;");
        ...
        langBtn.setOnAction(e -> {
            isEnglish = !isEnglish;
            root.setCenter(null); // Refresh
            root.setCenter(createTabPane());
            langBtn.setText(isEnglish ? "বাংলা" : "English");
            title.setText(getText("Ambulance & Emergency Services", "অ্যাম্বুলেন্স ও জরুরি সেবা"));
        });

        Button help = new Button(getText("Help", "সাহায্য"));
        help.setOnAction(e -> ClientFX.openHelpChat());

        HBox top = new HBox(10, title);
        Region spacer = new Region();
        HBox.setHgrow(spacer, Priority.ALWAYS);
        top.getChildren().addAll(spacer, panicBtn, langBtn, help);
